...
// change 5
// ✅ REVIEWED VERSION OF YOUR BACKEND
// Fixes: inconsistent logging, Gmail bot hits, Mongo duplicate key errors
...
// // Enhanced bot detection (Gmail proxy and common bots)
// const isBot = (ua, ip) => {
//   if (/bot|crawler|preview|headless|facebookexternalhit/i.test(ua)) return true;
//   if (ip.startsWith('66.249.')) return true; // Gmail image proxy
//   return false;
// };
...
//   if (!emailId || !recipientId || isBot(ua, ip)) {
//     console.log('⚠️ Skipped bot or missing data');
//     return;
//   }
